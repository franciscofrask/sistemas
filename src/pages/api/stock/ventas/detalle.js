import { service_GetDetalleVenta } from '@/services/ventas.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await service_GetDetalleVenta(parseInt(venta_id));
    ...
    console.error('Error en API detalle venta:', error);
