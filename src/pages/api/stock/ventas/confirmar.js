import { service_ConfirmarVenta } from '@/services/ventas.js';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const result = await service_ConfirmarVenta(parseInt(venta_id));
    ...
    console.error('Error en API confirmar venta:', error);
